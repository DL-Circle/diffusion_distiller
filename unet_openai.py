...
if __name__ == '__main__':
    ...
    model = create_model(128, 32, 1, in_channels=in_channels, out_channels=out_channels).cuda()
    x = th.randn(1, 3, 96, 128, 128).cuda() 
    t = th.randint(1, 1000, (1, )).cuda()
    o = model(x, t)
    print(o.shape)